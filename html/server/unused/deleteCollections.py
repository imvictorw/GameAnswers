...
try:
    ...
    #urlString = "?username=pikachu&collectionname=More+Trash&descript=Soo+Many+Trash"
    ...
    cursor.execute("DELETE FROM objects WHERE collectname_fk = '" + coll + "'")
    cursor.execute("DELETE FROM collectdescript WHERE collectionid_fk = " + str(idCol[0]))
